...
% PAGE DE GARDE
\include{00-Page-de-garde-BNH}

\pagenumbering{Roman}

% NOTE DE CONFIDENTIALITÉ (optionnelle)
% \include{00-Note}

% ÉLÉMENTS PRÉLIMINAIRES
\include{01-Dedicace-BNH}
\include{02-Remerciements-BNH}
\include{03-Resume-BNH}
...
\include{05-Introduction-BNH}

% CHAPITRE 1 : PRÉSENTATION DE LA BNH
\include{06-Presentation-BNH}

% CHAPITRE 2 : ÉTUDE DE L'EXISTANT ET ANALYSE DES BESOINS
\include{07-Existant-Besoins-BNH}

% CHAPITRE 3 : ANALYSE ET CONCEPTION DE LA SOLUTION
\include{08-Conception-BNH}

% CHAPITRE 4 : DÉVELOPPEMENT ET RÉALISATION
\include{09-Realisation-BNH}

% CHAPITRE 5 : RÉSULTATS ET ÉVALUATION
\include{10-Resultats-BNH}

% CONCLUSION GÉNÉRALE
\include{11-Conclusion-BNH}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% RÉFÉRENCES ET ANNEXES %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%choix du style de la bibliographie
